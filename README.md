...
Los cinco ejercicios cuentan con código fuente, simulación y documentación. El
ejercicio 5 muestra un reloj de 12 horas en un LCD mediante una interfaz de
datos de 4 bits.
